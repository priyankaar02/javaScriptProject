...
console.log("INDEXOF:", myArr.indexOf(9));

const newArr = myArr.join();  // join operation converts array to String
console.log("JOIN operation:", newArr);
...
console.log("Array before splice:", myArr.splice(1,3)); /* Splice method includes the last range (eg: includes 1, 2 and 3) and 
...
console.log("PUSH operation:", myFruits)
...
//console.log("CONCAT operation:", newArr1)
...
console.log("check if the data optained is an array using ISARRAY funtion: ", Array.isArray("Priyanka"))
console.log("convert the data optained into an array using FROM operation: ", Array.from("Priyanka"))
console.log("From operation for an object", Array.from({name : "Priyanka"})) /*Here you need to specify whether you need an 
                                                                               array from all keys or values */
