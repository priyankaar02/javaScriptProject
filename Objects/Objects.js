...
const JsUser = {
    name: "abc",
    "full name": "def",
    [mySym]: "myKey1", //declaring a symbol with [] brackets and must be accessed by []
    age: 18,
    location: "India",
    email: "abc@gmailcom",
    isLoggedIn: false,
...
console.log("Retrieve Object keys:", Object.keys(JsUser)) /*Important and very useful */
console.log("Retrieve Object values:", Object.values(JsUser));  /*Important and very useful */

console.log(Object.entries(JsUser));


/* ----- To check if the object has a particular property---- */
console.log("Check if an object has a property", JsUser.hasOwnProperty('email'));
...
JsUser.greeting = function() {
    console.log(`hello world ${this["full name"]}`);   //important
}

console.log(JsUser.greeting());

/*------------------Adding values to Objects -----------------------*/
const tinderUser3 = {}  //empty Object
...
const obj4 = {...obj1, ...obj2, ...obj3} /* Most frequently used method => Spread operator */
console.log(obj4);

/*------------- How to do when you recieve values from database as array of objects -------------*/
